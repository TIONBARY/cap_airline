...
- 나라마다 **수도 난이도 등급(1~5)**이 매겨져 있고, 그 등급이 출제 확률을 정한다.
  뒤로 갈수록 어려운 나라가 나올 확률이 올라간다
- **첫 3문제는 쉬운 나라(1~2등급)만 나온다.** 몸 풀 시간은 준다. 4번째부터는 복불복이다
- 100번째 나라까지 맞히면 **🌍 세계일주 완주** — 게임의 엔딩이다. **만점은 100점.**
...
- **오프라인 내장 블럭 세계지도** — 실제 지도를 120×60 격자로 다운샘플링. 대륙 모양이 살아있다.
  지도 바깥 여백도 같은 바다 블럭으로 채워져서, 화면이 아무리 넓어도 빈 공간이 안 보인다
